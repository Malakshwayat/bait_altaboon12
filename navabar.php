...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
    <div class="container-fluid">
       <a href="http://localhost/onlinestore/index.php" ><img src='./assets/pix/logo.jfif' alt="logo" class="logo"></a>
        ...
        <li class="nav-item">
        <a class="nav-link" href="http://localhost/onlinestore/index1.php">تسوق الكترونيا</a>
        </li>
        </ul>
        </div>
        <a href="http://localhost/onlinestore/login.php"><button type="button" class="btn btn-light">LogIn</button></a>
        <a href="http://localhost/onlinestore/online.php">
        <span id="cart-count" class="cart-count"></span>
        <img src='./assets/pix/pngtree-gray-linear-shopping-cart-vector-icon-image_1197249.jpg' alt="icon" class="icon">
        </a>
       </div>
</nav>
<script>
